...
<?php 
	...
	$rp = mysql_fetch_array($sqlp);
		...
		$sqlpr = mysql_query("select * from orderdetail, produk where orderdetail.idproduk=produk.idproduk and orderdetail.idorder='$_GET[ido]' and orderdetail.idpenjual='$rp[idpenjual]'");
	...
	// Tampilkan data Pembeli yang Pesan
		...
		echo "<table border='0' width='100%'>
				...
				<tr>
					<th>No Handphone</th>
					<td>$ra[nohpanggota]</td>
				</tr>
				<tr>
					<th>Email</th>
					<td>$ra[emailanggota]</td>
				</tr>
			</table>";
